...
test('Get specific seller account', async ({ request }) => {
    ...
    const response = await accountsRequest.getAccountWithFilter(marketplaceData.markeplaceId, sellerName, sellerEmail);
